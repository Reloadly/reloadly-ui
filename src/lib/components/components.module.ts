...
import { ButtonExampleComponent } from './button/button-example/button-example.component';
import { BadgeExampleComponent } from './badge/badge-example/badge-example.component';
import { SidebarComponent } from './sidebar/sidebar.component';
import { SidebarExampleComponent } from './sidebar/sidebar-example/sidebar-example.component';
import { SwitchComponent } from './switch/switch.component';
import { SwitchExampleComponent } from './switch/switch-example/switch-example.component';
import { SelectComponent } from './select/select.component';
import { SelectExampleComponent } from './select/select-example/select-example.component';
import { TooltipExampleComponent } from './tooltip/tooltip-example/tooltip-example.component';
import { MenuExampleComponent } from './menu/menu-example/menu-example.component';
import { DateComponent } from './date/date.component';
import { DateExampleComponent } from './date/date-example/date-example.component';
